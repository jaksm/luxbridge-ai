...
import { createMockRequestWithAuth, expectJSONResponse, expectErrorResponse } from "@/__tests__/utils/testHelpers";
    ...
    it("should return empty analysis for user with no holdings", async () => {
      ...
      expect(data).toMatchObject({
        ...
        rebalanceRecommendations: [{
          ...
          reasoning: "Consider starting with a diversified asset to build your portfolio"
        }]
      });
    });
