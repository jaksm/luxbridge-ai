...
async function simpleOracleTest() {
  ...
  try {
    ...
    const freshCode = await ethers.provider.getCode("0xffa7CA1AEEEbBc30C874d32C7e22F052BbEa0429");
  ...
  try {
    ...
    await sdk.oracle.mockPriceUpdate("test_platform", "TEST-001", ethers.parseEther("99999"));
